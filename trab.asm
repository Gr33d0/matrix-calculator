...
ProcurarMatriz:
  la $s0,0x10040000 # Endereço inicial
  #Primeira matriz
  la $s1,0x1004000c # Endereço modificavel
  lw $s2,0($s0) # Numero de elementos
  addi $s3,$s3,4 # adiciona s3 = 4
  mul $t2,$s2,$s3 # elementos * 4
  add $s1,$s1,$t2 # adiciona ao enderenço
  lw $t3, 0($s1) # Numero de elementos
  # Para achar qualquer matriz 1º se for por exemplo a segunda vai ter que achar o numero de elementos
